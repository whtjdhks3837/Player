...
class PaintBundle(private val context: Context, private val attrs: AttributeSet?) {
    ...
    val playBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_play_src,
    ...
    val pauseBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_pause_src,
    ...
    val previousBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_previous_src,
    ...
    val nextBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_next_src,
    ...
    val repeatOffBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_repeat_off_src,
    ...
    val repeatOneBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_repeat_one_src,
    ...
    val repeatAllBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_repeat_all_src,
    ...
    val shuffleOnBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_shuffle_on_src,
    ...
    val shuffleOffBitmap = context.getBitmap(
        typedArray.getResourceId(
            R.styleable.MediaControllerView_shuffle_off_src,
